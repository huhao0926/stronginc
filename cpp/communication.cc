...
int master_sum(int my_copy) {
    int tmp = 0;
    MPI_Reduce(&my_copy, &tmp, 1, MPI_INT, MPI_SUM, MASTER_RANK,
               MPI_COMM_WORLD);
    return tmp;
}
