...
void Bfs_Connectivity::bfs_parallel(Fragment &fragment, GraphView &dgraph, std::unordered_set<VertexID> &nodeset, VertexID root){
...
void Bfs_Connectivity::pEval(Fragment &fragment, GraphView &dgraph,std::unordered_set<VertexID> &nodeset, VertexID root){
...
void Bfs_Connectivity::incEval(Fragment &fragment, GraphView &dgraph,std::unordered_set<VertexID> &nodeset,  VertexID root){
std::queue<VertexID> que;
